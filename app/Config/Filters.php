...
class Filters extends BaseFilters
{
    ...
    public array $globals = [
        'before' => [
            // 'honeypot',
            'csrf'    => ['except' => ['bills/fetch-honorariums', 'bills/fetch-honorarium-trainings', 'bills/fetch-previous-trainings', 'bills/approve-honorarium', 'bills/get-statistics', 'bills/reject-honorarium', 'applications/fetch-applicants',
