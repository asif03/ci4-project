  ...
  <form action="<?=url_to('login')?>" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="username" inputmode="username"
                  autocomplete="username" class="form-control rounded-pill py-2" id="floatingUserNameInput" placeholder="BCPS 10 Digits Reg. No." value="<?=old('username')?>" required>
            </div>
            <div class="mb-3">
                <label for="floatingPasswordInput" class="form-label text-muted"><?=lang('Auth.password')?></label>
                <input type="password" class="form-control rounded-pill py-2" id="floatingPasswordInput" name="password" inputmode="text"
            ...
            <hr class="my-4">
            <div class="text-center">
                <p class="text-muted">Don't have username & password? <a href="#" class="text-green text-decoration-none fw-bold">Click Here</a></p>
            </div>
        </form>
