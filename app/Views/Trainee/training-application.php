            ...
            <div class="tab-content" id="pills-tabContent">
              ...
              <div class="tab-pane fade" id="tab-step-3" role="tabpanel" aria-labelledby="pills-step-3-tab">
                ...
                <div class="row g-3 mb-4">
                  ...
                  <div class="col-md-6">
                    <label for="fcpsSession" class="form-label">BMDC Registration Type</label>
                    <select id="fcpsSession" class="form-select">
                      <option value="" disabled selected>Select Session</option>
                      <option value="MBBS">
                        MBBS
                      </option>
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="number" class="form-control" id="bmdcRegNo" placeholder="e.g., 12345" required>
                  </div>
                </div>
                <div class="d-flex justify-content-between mt-4">
                  <button type="button" class="btn btn-outline-secondary prev-tab"><i
